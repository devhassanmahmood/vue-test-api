...
export default new Router({
    ...
    routes: [
        ...
        },
        {
            path: '/employees',
            name: 'employees',
            component: () => import('../DemoPages/Dashboards/Employees/Index.vue'),
        },
        {
            path: '/employees/new',
            name: 'new-employee',
            component: () => import('../DemoPages/Dashboards/Employees/New.vue'),
        },
        {
            path: '/employees/edit/:id',
            name: 'edit-employee',
            component: () => import('../DemoPages/Dashboards/Employees/Edit.vue'),
        },
