      ...
      <b-row>
        <b-col md="6">
          <b-card class="main-card mb-3">
            <vue-slider ref="slider" v-model="demo.default.value"></vue-slider>
            <br />
            <b>
              <small>Value:</small>
              {{ demo.default.value }}
        ...
        <b-col md="6">
          ...
          <b-card class="main-card mb-3">
            <vue-slider ref="slider5" v-model="demo.demo5.value" direction="btt"
              tooltipDir="left" :height="300" style="display: inline-block; margin: 30px;">
            </vue-slider>
            <vue-slider v-model="demo.demo5.value" :reverse="false" tooltipDir="right" direction="ttb"
